...
""" def ler_csv_pl(arquivo): return ( pl.read_csv( arquivo, \# Impede o erro forçando a leitura como texto apenas nesta coluna schema_overrides={"trip_distance": pl.String} ) .with_columns( \# Remove a vírgula e converte para float pl.col("trip_distance").str.replace(",", "").cast(pl.Float64) ) ) """
